...
- when applicable, the curated skills subtree path to consult (a Glob
  pattern the parent has already resolved against `AR_SKILLS_ROOT`)
...
- Glob / Grep restricted to the named skills subtree and the 4 task
  files. Do not wander the wider repo.
