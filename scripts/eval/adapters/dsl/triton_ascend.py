...
"""
        code += """try:
    from eval.triton_autotune_patch import apply_triton_patches
...
"""
        code = f"""{set_framework_code}        try:
            ...
            from eval.triton_autotune_patch import get_collected_config_timings, clear_collected_config_timings
            # 清除之前的配置信息
